# Senior .NET Developer Applicant
...
1. **Execute the following command from Docker**:

	```bash
	docker exec -it my_db_pg_container bash 
	```
2. **Connect to the PostgreSQL database**:
	
	```bash
	psql -h my_db_pg_container -U postgres
	```
Enter the password when prompted: 123456

3. **Create the Medical Database**: If the medical database hasn't been created yet, execute the following SQL command:
 ```sql
CREATE DATABASE medical;
```
4. **Connect to the Medical Database**: Use the following command to connect to the medical database:

 ```sql
\c medical
 ```
 
5. **Run SQL Scripts**: Execute the provided SQL script to create the necessary tables in the medical database:
...
-- Table for patient visits to medical facilities
...
VALUES 
    ('2d8a35a6-d8f1-4fd9-aae5-c10f810ea64f', 'John', 'Doe', 1, '1b2493f7-0896-4856-a1c7-dab4a6f9c54f'), -- Asociado con State Farm
    ...
    ('545f41d9-d6a1-4153-9873-2a85ec98ef19', 'Emily', 'Brown', 3, 'e55bc96e-0182-4c56-bc4c-43d6f529ff9e'), -- Asociado con Progressive
    ('dc7ff441-df78-4d5a-ba17-b7ccdeac6f4a', 'William', 'Taylor', 4, '30d17a94-c6d9-4b7f-a218-bde3a8fbb3b0'), -- Asociado con Nationwide
    ...
    ('5751024b-d3f1-4433-8f25-1f5cfb145417', 'Linda', 'Martinez', 9, '8db0744f-c0f8-4b38-9035-348a7d28c5bb'), -- Asociado con USAA
    ...
    ('f28f4863-4504-4d1d-8f2f-564289c79f91', 'Maria', 'Lee', 10, 'a6074d81-46db-4e8e-8d16-61e42b018ba9'), -- Asociado con State Farm
    ...
    ('5b19b18e-31ee-4d0a-a505-af2c7592aa15', 'Robert', 'Chen', 12, '9a2c16b5-d38d-498e-bcb8-dc4cb4594d51'), -- Asociado con MetLife
